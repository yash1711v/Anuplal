...
class CategoryProducts{
  ...
  CategoryProducts({this.id, this.name, this.thumbnail, this.price, this.discount_price, this.rating, this.total_reviews, this.total_sold, this.quantity, this.is_favorite
